...
- Clearer admin error when the server returns HTML instead of JSON (e.g. timeout)
...
- Removed unsupported `thinking` and `quality` parameters from gpt-image-2 requests
